    ...
    <div>
      ...
      <div style={{ background: '#f5f5f5', borderRadius: 10, padding: '1rem', marginBottom: '1.25rem', border: '1px solid #ebebeb' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
          ...
          <button onClick={() => setShowExpenseForm(v => !v)} style={{ background: '#7B1C1C', color: '#fff', border: 'none', borderRadius: 999, padding: '0.3rem 0.7rem', fontSize: '0.75rem', cursor: 'pointer', fontWeight: 700 }}>+ Add</button>
        </div>
        ...
        {showExpenseForm && (
          <div style={{ background: '#f5f5f5', borderRadius: 8, padding: '0.85rem', marginBottom: '0.75rem', display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              ...
              <button onClick={addExpense} disabled={savingExp} style={{ flex: 2, background: '#7B1C1C', color: '#fff', border: 'none', borderRadius: 999, padding: '0.5rem', fontWeight: 700, cursor: 'pointer' }}>
      ...
      <div style={{ background: '#f5f5f5', borderRadius: 10, padding: '1rem', border: '1px solid #ebebeb' }}>
        ...
        />
        <button onClick={saveRemark} disabled={savingRemark} style={{ background: '#7B1C1C', color: '#fff', border: 'none', borderRadius: 999, padding: '0.5rem 1rem', fontWeight: 700, cursor: 'pointer', fontSize: '0.82rem' }}>
