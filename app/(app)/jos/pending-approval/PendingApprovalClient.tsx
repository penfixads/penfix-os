                    ...
                    {showReject === jo.job_order_id ? (
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                        ...
                        <div style={{ display: 'flex', gap: 8 }}>
                          ...
                          <button onClick={() => reject(jo.job_order_id)} disabled={isActing} style={{ flex: 2, background: '#7B1C1C', color: '#fff', border: 'none', borderRadius: 999, padding: '0.5rem', cursor: 'pointer', fontWeight: 700, fontSize: '0.8rem' }}>
