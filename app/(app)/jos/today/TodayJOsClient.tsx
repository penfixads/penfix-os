            ...
            <div style={fieldStyle}>
              ...
              {showPaymentForm ? (
                <div style={{ background: '#f0f0f0', borderRadius: 8, padding: '0.85rem', display: 'flex', flexDirection: 'column', gap: 8 }}>
                  ...
                  <div style={{ display: 'flex', gap: 8 }}>
                    <button onClick={addPayment} style={{ flex: 1, background: '#7B1C1C', color: '#fff', border: 'none', borderRadius: 999, borderRadius: 7, padding: '0.5rem', cursor: 'pointer', fontWeight: 700 }}>Add</button>
