  ...
  return (
    <div style={{ display: 'flex', gap: '0.75rem', marginTop: '0.4rem', flexWrap: 'wrap' }}>
      {options.map(opt => {
        ...
        return (
          <label key={opt} style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', cursor: 'pointer', padding: '0.4rem 0.9rem', borderRadius: 20, border: `1.5px solid ${active ? '#7B1C1C' : '#ccc'}`, background: active ? '#7B1C1C' : '#fff', color: active ? '#fff' : '#555', fontSize: '0.875rem', fontWeight: active ? 600 : 400 }}>
